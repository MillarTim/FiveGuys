...
public partial class Sweep : BlockingRecord
{
...
public partial class Detail : PhysicalRecord
{
public string RecordId { get; set; } // max length 2; required False
public string FileIdentifier { get; set; } // max length 10; required False
public string FileNumber { get; set; } // max length 2; required False
public string Fund { get; set; } // max length 9; required False
public string BetaSecurityNumber { get; set; } // max length 9; required False
public string DateTimeUpdated { get; set; } // max length 16; required False
private DateTime? _dateTimeUpdatedFormatted;
public DateTime DateTimeUpdatedFormatted
{
	get
	{
		if (_dateTimeUpdatedFormatted == null)
		{
			_dateTimeUpdatedFormatted = DateTime.Parse(Formatter.Format(DateTimeUpdated, @"(\d{2})/(\d{2})/(\d{2})(\d{2}):(\d{2}):(\d{2})~20$3/$1/$2T$4:$5:$6~DateTime"));
		}
		return (DateTime)_dateTimeUpdatedFormatted;
	}
}

public string TotalWireAmountForBuys { get; set; } // max length 18; required False
private Decimal? _totalWireAmountForBuysFormatted;
public Decimal TotalWireAmountForBuysFormatted
{
	get
	{
		if (_totalWireAmountForBuysFormatted == null)
		{
			_totalWireAmountForBuysFormatted = Decimal.Parse(Formatter.Format(TotalWireAmountForBuys, @"([-\d]\d{15})(\d{2})~$1.$2~Decimal"));
		}
		return (Decimal)_totalWireAmountForBuysFormatted;
	}
}

public string TotalWireAmountForSells { get; set; } // max length 18; required False
private Decimal? _totalWireAmountForSellsFormatted;
public Decimal TotalWireAmountForSellsFormatted
{
	get
	{
		if (_totalWireAmountForSellsFormatted == null)
		{
			_totalWireAmountForSellsFormatted = Decimal.Parse(Formatter.Format(TotalWireAmountForSells, @"([-\d]\d{15})(\d{2})~$1.$2~Decimal"));
		}
		return (Decimal)_totalWireAmountForSellsFormatted;
	}
}
...
public partial class Trailer : PhysicalRecord
{
public string RecordId { get; set; } // max length 2; required False
public string FileIdentifier { get; set; } // max length 10; required False
public string FileNumber { get; set; } // max length 2; required False
...
[System.Xml.Serialization.XmlInclude(typeof(Sweep))]
